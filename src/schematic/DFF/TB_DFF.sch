...
C {lab_pin.sym} 1060 -260 0 0 {name=p2 sig_type=std_logic lab=clk
}
...
.MEASURE TRAN tdrise_b TRIG v(clk) VAL='0.5*PAR_VDD' FALL=1 TARG v(q) VAL='0.5*PAR_VDD' RISE=1
.MEASURE TRAN tdfall_b TRIG v(clk) VAL='0.5*PAR_VDD' RISE=1 TARG v(q) VAL='0.5*PAR_VDD' FALL=1
...
C {lab_pin.sym} 1060 -150 0 0 {name=p4 sig_type=std_logic lab=d
}
C {lab_pin.sym} 1120 -310 0 0 {name=p5 sig_type=std_logic lab=d
}
C {lab_pin.sym} 1120 -290 0 0 {name=p6 sig_type=std_logic lab=clk
}
